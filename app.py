from flask import Flask, render_template, redirect, url_for, flash, request, jsonify, send_from_directory, abort,send_file, abort
...
def pay():
    ...
    if form.validate_on_submit():
        ...
        if existing_user:
            ...
            return render_template('register.html', form=form, RegisterSuccess=register_success)
...
def download(file_type):
    ...
    if file_type == 'basic' and current_user.basicbuyer:
        file_path = 'path/to/basic_file.zip' 
    elif file_type == 'standart' and current_user.standartbuyer:
        file_path = 'path/to/standart_file.zip' 
    elif file_type == 'premium' and current_user.premiumbuyer:
        file_path = 'path/to/premium_file.zip'
    else:
        abort(404)
